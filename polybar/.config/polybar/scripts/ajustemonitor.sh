...
if [ "$res" ]; then
	case $res in
		'Conectar HDMI') exec $app --output eDP1 --mode 1366x768 --primary --output HDMI1 --mode 1920x1080 --right-of HDMI1 & exec i3-msg restart ;;
		'Desconectar HDMI') exec $app --output HDMI1 --off & exec i3-msg restart ;;
		'Espelhar HDMI') exec $app --output HDMI1 --output eDP1 --mode 1366x768 --same-as HDMI1 & exec i3-msg restart ;;
